        ...
        return (
            <Layout>
                ...
                <Card padding="lg" className="text-center">
                    ...
                    <h1 className="text-xl font-bold text-ink">Место не найдено</h1>
                </Card>
            </Layout>
        );
    }
        ...
        <Layout>
            ...
            <div className="animate-fade-in-up">
                                    ...
                                    {images.map((_, index) => (
                                        <span
                                            ...
                                            className={`h-1.5 rounded-full transition-all ${
                                                index === slide ? "w-6 bg-white" : "w-1.5 bg-white/60"
                                            }`}
                                        />
                                    ))}
                                </div>
                ...
                <Card padding="md" className="mb-5">
                    ...
                    <div className="mt-5">
                        <h3 className="font-semibold text-ink mb-3">Почему стоит сходить</h3>
                ...
                {place.socials && place.socials.length > 0 && (
                    <Card padding="md" className="mb-5">
                        <h2 className="text-lg font-bold text-ink mb-3">Социальные сети</h2>
                        <div className="flex flex-wrap gap-2">
                            {place.socials.map((social) => (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="inline-flex items-center gap-2 rounded-xl border border-border bg-surface-muted px-3 py-2 text-sm font-semibold text-brand-700 hover:bg-brand-50 transition"
                                >
